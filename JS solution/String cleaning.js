...
function stringClean(s) {
    ...
    arr = arr.filter(s => s !== '2')
    arr = arr.filter(s => s !== '3')
    arr = arr.filter(s => s !== '4')
    arr = arr.filter(s => s !== '5')
    arr = arr.filter(s => s !== '6')
    arr = arr.filter(s => s !== '7')
    arr = arr.filter(s => s !== '8')
    arr = arr.filter(s => s !== '9')
